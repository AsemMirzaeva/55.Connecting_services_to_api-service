...
type TaskServiceClient interface {
	...
	ListTasks(ctx context.Context, in *Empty, opts ...grpc.CallOption) (TaskService_ListTasksClient, error)
...
func (c *taskServiceClient) ListTasks(ctx context.Context, in *Empty, opts ...grpc.CallOption) (TaskService_ListTasksClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type TaskServiceServer interface {
	...
	ListTasks(*Empty, TaskService_ListTasksServer) error
...
func (UnimplementedTaskServiceServer) ListTasks(*Empty, TaskService_ListTasksServer) error {
